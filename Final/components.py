...
class Player(pg.sprite.Sprite):
    def __init__(self, display, left, right, x, y, idle, jump, attack, game):
    ...
    def update(self):
        ...
        score_text = font.render("COINS: " + str(self.coins), True, RED)
        self.display.blit(score_text, (600, 500))
...
# Update animation if attacking
    ...
    def attack_enemy(self, dir):
        if dir == 'x':
            enemy = pg.sprite.spritecollide(self, self.game.enemy_sprite, False)
            if enemy:  
                self.rect.right = enemy[0].rect.left
                print("HITS")
            #     self.damage = True  
            #     self.rect.left = enemy[0].rect.right
            # if self.damage == True:
            #     enemy.rect.y = - 100
                # elif self.vy < 0:  
                #     self.rect.top = hits[0].rect.bottom
...
class Collision(pg.sprite.Sprite):
    def __init__(self, display, x, y, width, height, image):
        ...
        self.width = width
        self.height = height
    def collide_with_wall(self, dir, player_list):
...
class Object(pg.sprite.Sprite):
    def __init__(self, display, x, y, images, game):
        ...
        self.delay = 70  # Delay in milliseconds
        self.last = pg.time.get_ticks()
