...
class Player(pg.sprite.Sprite):
    def __init__(self, display, left, right, up, down, x, y, idle, jump, game):
    ...
    #     if dir == 'x':
    #         hits = pg.sprite.spritecollide(self, self.game.enemy_group, False)
    #         if hits:
    #             if self.vx > 0:
    #                 self.HP -= 25
    #             elif self.vx < 0:  
   ...
   # collision detection with masks
    ...
    #     if pg.sprite.spritecollide(self, self.game.wall_group, False):
    #         hits = pg.sprite.spritecollide(self, self.game.wall_group, False, pg.sprite.collide_mask)
    #         if hits:
    #             if self.vx > 0:
